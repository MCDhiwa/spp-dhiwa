...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <?php if (isset($_SESSION['leveluser']) && $_SESSION['leveluser'] == '0') : ?>
            <a href="../kelas/index.php" class="icon-a"><i class="fa fa-users icons"></i> &nbsp;&nbsp;Kelas</a>
        <?php endif; ?>
        <?php if (isset($_SESSION['leveluser'])) : ?>
            <a href="../pembayaran/input.php" class="icon-a"><i class="fa fa-shopping-bag icons"></i> &nbsp;&nbsp;Pembayaran</a>
        <?php endif; ?>
        <?php if (isset($_SESSION['leveluser']) && $_SESSION['leveluser'] == '0') : ?>
